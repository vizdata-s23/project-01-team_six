...
new_poll |> 
  ...
  geom_smooth(method = 'loess',
    ...
    geom_line(data = line_data, aes(x = year, y = mean_rq, group = industry, color = industry, linetype = "industry mean"), linewidth = 1) +
  facet_wrap(~ industry, ncol = 4) +
   geom_point(data = line_data, aes(x = year, y = mean_rq), size = 3) +
    theme_minimal() +
